...
def test_dark_theme_by_time():
    ...
    time_22_00 = time(hour=22)
    time_06_00 = time(hour=6)
    # TODO переключите темную тему в зависимости от времени суток (с 22 до 6 часов утра - ночь)
    is_dark_theme = True if (time_22_00 <= current_time or current_time <= time_06_00) else False
...
def test_dark_theme_by_time_and_user_choice():
    ...
    if (time_22_00 <= current_time or current_time <= time_06_00) and dark_theme_enabled_by_user is None:
        is_dark_theme = True
